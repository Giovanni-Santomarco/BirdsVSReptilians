    ...
    public class TelegraphedShootManager : ShootManagerForEnemy
    {
        ...
        private void UpdateLaserPosition()
        {
            ...
            // Usiamo la nostra nuova laserDirection corretta per il Raycast
        ...
        //Questa funzione controlla se il nemico sta mirando bene
        private bool IsAimingWell()
        {
            ...
            RaycastHit2D hit = Physics2D.Raycast(gunController.firePoint.position, aimDirection, Mathf.Infinity, checkLayers);
